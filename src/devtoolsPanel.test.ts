...
describe("devtoolsPanel", () => {
    ...
    let mockWebviewEvents: { WebviewEvents: WebviewEvents, postMessageAcrossChannel: jest.Mock };
    ...
    beforeEach(() => {
        ...
        mockWebviewEvents = {
            WebviewEvents: WebviewEvents as any,
    ...
    describe("dispose", () => {
        it("calls dispose on all event handlers", async () => {
            ...
            const addDisposable = (isDispose: boolean) => (_callback: () => void, thisArg: any, disposables: any[]) => {
                const disposable = {
                    dispose: jest.fn(),
                };
    ...
    describe("panelSocket", () => {
        it("listens for all the emit events", async () => {
            ...
            mockPanelSocket.on.mockImplementation(((name: string) => {
            ...
            expect(mockPanelSocket.on).toHaveBeenCalledTimes(Object.keys(WebviewEvents).length);
        ...
        it("forwards panel socket messages to the webview", async () => {
            ...
            callback.call(thisObj, expectedMessage);
            expect(mockWebviewEvents.postMessageAcrossChannel).toBeCalledWith(
                WebviewEvents.websocket,
                expectedMessage,
                mockPanel.webview);
        });
        ...
        describe("events", () => {
            ...
            beforeEach(() => {
                ...
                mockPanelSocket.on.mockImplementation(((name: string, callback: (msg: string) => void) => {
            ...
            it("updates value for set state", async () => {
                ...
                expect(context.workspaceState.update).toBeCalledWith(SETTINGS_PREF_NAME, expectedState);
            });
