...
async function patchFilesForWebView(toolsOutDir: string, debugMode: boolean) {
    ...
    if (!debugMode) {
        ...
        await patchFileForWebViewWrapper("main/MainImpl.js", toolsOutDir, true, [applyMainViewPatch]);
        await patchFileForWebViewWrapper("common/Revealer.js", toolsOutDir, true, [applyCommonRevealerPatch]);
        ...
        await patchFileForWebViewWrapper("inspector.html", toolsOutDir, true, [applyContentSecurityPolicyPatch]);
        await patchFileForWebViewWrapper("ui/InspectorView.js", toolsOutDir, true, [applyDrawerTabLocationPatch]);
        ...
        await patchFileForWebViewWrapper("quick_open/QuickOpen.js", toolsOutDir, true, [applyHandleActionPatch]);
        await patchFileForWebViewWrapper("quick_open/CommandMenu.js", toolsOutDir, true, [applyHandleActionPatch]);
    } else {
        // tslint:disable-next-line:no-console
        console.log("Patching files for debug version");
        await patchFileForWebViewWrapper("main/MainImpl.js", toolsOutDir, false, [applyMainViewPatch]);
        await patchFileForWebViewWrapper("common/Revealer.js", toolsOutDir, false, [applyCommonRevealerPatch]);
        await patchFileForWebViewWrapper("elements/elements_module.js", toolsOutDir, false, [
            applySetupTextSelectionPatch,
            applyPaddingInlineCssPatch,
        ]);
        await patchFileForWebViewWrapper("inspector.html", toolsOutDir, false, [applyContentSecurityPolicyPatch]);
        await patchFileForWebViewWrapper("ui/InspectorView.js", toolsOutDir, false, [applyDrawerTabLocationPatch]);
        ...
        await patchFileForWebViewWrapper("quick_open/CommandMenu.js", toolsOutDir, true, [applyHandleActionPatch]);
        // Debug file versions
        await patchFileForWebViewWrapper("ui/UIUtils.js", toolsOutDir, false, [applyUIUtilsPatch]);
        await patchFileForWebViewWrapper("dom_extension/DOMExtension.js", toolsOutDir, false, [applyCreateElementPatch]);
        await patchFileForWebViewWrapper("elements/ElementsPanel.js", toolsOutDir, false, [applySetupTextSelectionPatch]);
        ...
        await patchFileForWebViewWrapper("elements/elementsTreeOutline.css", toolsOutDir, false, [applyPaddingInlineCssPatch]);
        await patchFileForWebViewWrapper("elements/stylesSectionTree.css", toolsOutDir, false, [applyPaddingInlineCssPatch]);
    }
}

// This function wraps the patchFileForWebView function and catches any error thrown inside patchFileForWebView
// Catching and logging the errors will return an exit code of 1 for the process (was previously 0)
