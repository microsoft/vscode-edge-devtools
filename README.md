...
Out of the box the browser does not track live changes to the code you write. If you want the extension to automatically refresh the browser when you changed a file, you need to set up a live reload environment. For this you need Node.js and npm on your machine. 
...
* Navigate to localhost:8080/{file name you want to open}	
